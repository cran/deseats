#'Shiny App for Decomposing Seasonal Time Series (Deprecated)
#'
...
#'saved in CSV format.
#'
#'Note: This function is deprecated. Switch to \code{run_decomposition()}.
#'
#'@export
#'
#'@return
...
runDecomposition <- function() {
  ...
  warning("This function is deprecated. Switch to run_decomposition() instead.")
